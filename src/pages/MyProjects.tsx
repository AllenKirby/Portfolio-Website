    ...
    <section id="projects" className="w-full h-fit p-10">
        <header className="w-full h-fit flex flex-col lg:flex-row items-center justify-center mb-4">
          <div className='w-full lg:w-2/5 lg:py-10 flex items-center justify-center'>
            <h1 className='text-2xl lg:text-4xl font-extrabold uppercase bg-gradient-to-r from-secondary to-white bg-clip-text text-transparent'>My Projects</h1>
          </div>
          <div className='w-full lg:w-3/5 lg:py-10 flex items-center justify-center'>
            <p className='text-sm lg:text-lg font-medium text-center text-white'>These are the projects I developed during my college years that significantly enhanced my frontend development skills.</p>
          </div>
        </header>
