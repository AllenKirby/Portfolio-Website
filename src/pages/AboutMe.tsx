    ...
    <section id="aboutme" className="w-full h-fit">
        ...
        <main className="w-full h-full flex flex-col py-5">
            <div className="w-full flex flex-col lg:flex-row items-center justify-center">
                <figure className="w-full lg:w-1/2 h-full flex items-center justify-center">
            ...
            <div className="w-full flex flex-col lg:flex-row items-center justify-center">
                <figure className="flex w-1/2 h-full lg:hidden items-center justify-center">
                ...
                <figure className="hidden w-1/2 h-full lg:flex items-center justify-center">
                    <Lottie lottieProp={Goal}/>
                </figure>
            </div>
        </main>
